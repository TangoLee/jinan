...
--------------------------------*/
function imghover(){
$("a.fancy img,a.iframe img").mouseover(function(){
	$(this).stop(true,true);
	$(this).fadeTo(300, 0.6);
});

$("a.fancy img,a.iframe img").mouseout(function(){
	$(this).fadeTo(400, 1.0);
});
...
function imghover2(){
$(".intro-social>li>a>img").css('opacity',0.5);
$(".intro-social>li>a>img").mouseover(function(){
	$(this).stop(true,true);
	$(this).fadeTo(300, 1.0);
});

$(".intro-social>li>a>img").mouseout(function(){
	$(this).fadeTo(400, 0.5);
});
...
$('.show').show();
	...
	$('li.trigger a').click(function(e){
		/* Finding the drop down list that corresponds to the current section: */
		var dropDown = $(this).parent().next();

		$("li.trigger a").addClass("active").not(this).removeClass("active");
